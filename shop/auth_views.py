...
def login(request, template_name='files/login.html',
          redirect_field_name=REDIRECT_FIELD_NAME,
...
class LogoutView(SuccessURLAllowedHostsMixin, TemplateView):
    ...
    next_page = None
    redirect_field_name = REDIRECT_FIELD_NAME
    template_name = 'files/logged_out.html'
    extra_context = None
...
def rd_to_login(next, login_url=None,
                      redirect_field_name=REDIRECT_FIELD_NAME):
    """
    Redirects the user to the login page, passing the given 'next' page
    """

    return redirect_to_login(next, login_url=None, redirect_field_name=REDIRECT_FIELD_NAME)
...
def password_reset(request,
                   template_name='files/password_reset_form.html',
                   email_template_name='files/password_reset_email.html',
                   subject_template_name='files/password_reset_subject.txt',
    ...
    if post_reset_redirect is None:
        post_reset_redirect = reverse('shop:password_reset_done')
    else:
...
def password_reset_confirm(request, uidb64=None, token=None,
    ...
    if post_reset_redirect is None:
        post_reset_redirect = reverse('shop:password_reset_complete')
    else:
        post_reset_redirect = resolve_url(post_reset_redirect)
    try:
...
def password_reset_complete(request,
                            template_name='files/password_reset_complete.html',
                            extra_context=None):
...
def password_change(request,
                    template_name='files/password_change_form.html',
...
def password_change_done(request,
                         template_name='files/password_change_done.html',
                         extra_context=None):
